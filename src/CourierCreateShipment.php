...
use Sylapi\Courier\Dummy\Entities\Shipment as ShipmentEntity;
use Sylapi\Courier\Dummy\Responses\Shipment as ShipmentResponse;
...
class CourierCreateShipment implements CourierCreateShipmentContract
{
    ...
    public function createShipment(Shipment $shipment): ResponseShipment
    {
        ...
        try{
            ...
            if($shipment->getCustomOption() === TestId::ERROR->value) {
